...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/annarini/Downloads/CGT COG CONT/ospan_lastrun.py',
...
Recall_Letters1Clock = core.Clock()
...
P = visual.TextStim(win=win, name='P',
    text='P',
    font='Open Sans',
    units='pix', pos=Pboxloc, height=0.05, wrapWidth=None, ori=0.0, 
...
F_2 = visual.TextStim(win=win, name='F_2',
    text='F',
    font='Open Sans',
    units='pix', pos=Fboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-15.0);
H = visual.TextStim(win=win, name='H',
    text='H',
    font='Open Sans',
    units='pix', pos=Hboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-16.0);
S = visual.TextStim(win=win, name='S',
    text='S',
    font='Open Sans',
    units='pix', pos=Sboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-17.0);
K = visual.TextStim(win=win, name='K',
    text='K',
    font='Open Sans',
    units='pix', pos=Kboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-18.0);
N = visual.TextStim(win=win, name='N',
    text='N',
    font='Open Sans',
    units='pix', pos=Nboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-19.0);
L = visual.TextStim(win=win, name='L',
    text='L',
    font='Open Sans',
    units='pix', pos=Lboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-20.0);
Q = visual.TextStim(win=win, name='Q',
    text='Q',
    font='Open Sans',
    units='pix', pos=Qboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-21.0);
R = visual.TextStim(win=win, name='R',
    text='R',
    font='Open Sans',
    units='pix', pos=Rboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-22.0);
J = visual.TextStim(win=win, name='J',
    text='J',
    font='Open Sans',
    units='pix', pos=Jboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-23.0);
Y = visual.TextStim(win=win, name='Y',
    text='Y',
    font='Open Sans',
    units='pix', pos=Yboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-24.0);
T_2 = visual.TextStim(win=win, name='T_2',
    text='T',
    font='Open Sans',
    units='pix', pos=Tboxloc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-25.0);
CLEAR = visual.Rect(
    win=win, name='CLEAR',units='pix', 
...
ClearText = visual.TextStim(win=win, name='ClearText',
    text='CLEAR',
    font='Open Sans',
    units='pix', pos=clearBoxLoc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-27.0);
BLANK = visual.Rect(
...
BlankText = visual.TextStim(win=win, name='BlankText',
    text='BLANK',
    font='Open Sans',
    units='pix', pos=blankBoxLoc, height=0.05, wrapWidth=None, ori=0.0, 
    color='Black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-29.0);
ENTER = visual.Rect(
    win=win, name='ENTER',units='pix', 
    width=specialBoxSize[0], height=specialBoxSize[1],
...
EnterText = visual.TextStim(win=win, name='EnterText',
    text='ENTER',
    font='Open Sans',
    units='pix', pos=enterBoxLoc, height=0.05, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-31.0);
...
CogConIns1Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "CogConIns1"-------
while continueRoutine:
    # get current time
    t = CogConIns1Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=CogConIns1Clock)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
CogConIns2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "CogConIns2"-------
while continueRoutine:
    # get current time
    t = CogConIns2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=CogConIns2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
CogConIns3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "CogConIns3"-------
while continueRoutine:
    # get current time
    t = CogConIns3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=CogConIns3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisTrial in trials:
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    LetterPracClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "LetterPrac"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = LetterPracClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=LetterPracClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if letterDisp.status == STARTED:
            ...
            if tThisFlipGlobal > letterDisp.tStartRefresh + 1.0-frameTolerance:
                ...
                win.timeOnFlip(letterDisp, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in LetterPracComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials.addData('letterDisp.started', letterDisp.tStartRefresh)
    trials.addData('letterDisp.stopped', letterDisp.tStopRefresh)
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    itiPracClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "itiPrac"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = itiPracClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=itiPracClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
...
for thisTrial_2 in trials_2:
    ...
    # keep track of which components have finished
    Recall_Letters1Components = [PBox, NBox2, SBox2, KBox2, HBox, FBox, QBox, LBox, RBox, TBox, YBox, JBox, RecallINS, P, F_2, H, S, K, N, L, Q, R, J, Y, T_2, CLEAR, ClearText, BLANK, BlankText, ENTER, EnterText, mouse]
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    Recall_Letters1Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "Recall_Letters1"-------
    while continueRoutine:
        # get current time
        t = Recall_Letters1Clock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=Recall_Letters1Clock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
    ...
    for thisComponent in Recall_Letters1Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials_2.addData('PBox.started', PBox.tStartRefresh)
    trials_2.addData('PBox.stopped', PBox.tStopRefresh)
    trials_2.addData('NBox2.started', NBox2.tStartRefresh)
    trials_2.addData('NBox2.stopped', NBox2.tStopRefresh)
    trials_2.addData('SBox2.started', SBox2.tStartRefresh)
    trials_2.addData('SBox2.stopped', SBox2.tStopRefresh)
    trials_2.addData('KBox2.started', KBox2.tStartRefresh)
    trials_2.addData('KBox2.stopped', KBox2.tStopRefresh)
    trials_2.addData('HBox.started', HBox.tStartRefresh)
    trials_2.addData('HBox.stopped', HBox.tStopRefresh)
    trials_2.addData('FBox.started', FBox.tStartRefresh)
    trials_2.addData('FBox.stopped', FBox.tStopRefresh)
    trials_2.addData('QBox.started', QBox.tStartRefresh)
    trials_2.addData('QBox.stopped', QBox.tStopRefresh)
    trials_2.addData('LBox.started', LBox.tStartRefresh)
    trials_2.addData('LBox.stopped', LBox.tStopRefresh)
    trials_2.addData('RBox.started', RBox.tStartRefresh)
    trials_2.addData('RBox.stopped', RBox.tStopRefresh)
    trials_2.addData('TBox.started', TBox.tStartRefresh)
    trials_2.addData('TBox.stopped', TBox.tStopRefresh)
    trials_2.addData('YBox.started', YBox.tStartRefresh)
    trials_2.addData('YBox.stopped', YBox.tStopRefresh)
    trials_2.addData('JBox.started', JBox.tStartRefresh)
    trials_2.addData('JBox.stopped', JBox.tStopRefresh)
    trials_2.addData('RecallINS.started', RecallINS.tStartRefresh)
    trials_2.addData('RecallINS.stopped', RecallINS.tStopRefresh)
    trials_2.addData('P.started', P.tStartRefresh)
    trials_2.addData('P.stopped', P.tStopRefresh)
    trials_2.addData('F_2.started', F_2.tStartRefresh)
    trials_2.addData('F_2.stopped', F_2.tStopRefresh)
    trials_2.addData('H.started', H.tStartRefresh)
    trials_2.addData('H.stopped', H.tStopRefresh)
    trials_2.addData('S.started', S.tStartRefresh)
    trials_2.addData('S.stopped', S.tStopRefresh)
    trials_2.addData('K.started', K.tStartRefresh)
    trials_2.addData('K.stopped', K.tStopRefresh)
    trials_2.addData('N.started', N.tStartRefresh)
    trials_2.addData('N.stopped', N.tStopRefresh)
    trials_2.addData('L.started', L.tStartRefresh)
    trials_2.addData('L.stopped', L.tStopRefresh)
    trials_2.addData('Q.started', Q.tStartRefresh)
    trials_2.addData('Q.stopped', Q.tStopRefresh)
    trials_2.addData('R.started', R.tStartRefresh)
    trials_2.addData('R.stopped', R.tStopRefresh)
    trials_2.addData('J.started', J.tStartRefresh)
    trials_2.addData('J.stopped', J.tStopRefresh)
    trials_2.addData('Y.started', Y.tStartRefresh)
    trials_2.addData('Y.stopped', Y.tStopRefresh)
    trials_2.addData('T_2.started', T_2.tStartRefresh)
    trials_2.addData('T_2.stopped', T_2.tStopRefresh)
    trials_2.addData('CLEAR.started', CLEAR.tStartRefresh)
    trials_2.addData('CLEAR.stopped', CLEAR.tStopRefresh)
    trials_2.addData('ClearText.started', ClearText.tStartRefresh)
    trials_2.addData('ClearText.stopped', ClearText.tStopRefresh)
    trials_2.addData('BLANK.started', BLANK.tStartRefresh)
    trials_2.addData('BLANK.stopped', BLANK.tStopRefresh)
    trials_2.addData('BlankText.started', BlankText.tStartRefresh)
    trials_2.addData('BlankText.stopped', BlankText.tStopRefresh)
    trials_2.addData('ENTER.started', ENTER.tStartRefresh)
    trials_2.addData('ENTER.stopped', ENTER.tStopRefresh)
    trials_2.addData('EnterText.started', EnterText.tStartRefresh)
    trials_2.addData('EnterText.stopped', EnterText.tStopRefresh)
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    LetterScoreClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "LetterScore"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = LetterScoreClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=LetterScoreClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
MathPracInsClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "MathPracIns"-------
while continueRoutine:
    # get current time
    t = MathPracInsClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=MathPracInsClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
MathPracIns2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "MathPracIns2"-------
while continueRoutine:
    # get current time
    t = MathPracIns2Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=MathPracIns2Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
MathPrac3Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "MathPrac3"-------
while continueRoutine:
    # get current time
    t = MathPrac3Clock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=MathPrac3Clock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisTrial_3 in trials_3:
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    MathPracClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "MathPrac"-------
    while continueRoutine:
        # get current time
        t = MathPracClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=MathPracClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    isiPracMathClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "isiPracMath"-------
    while continueRoutine:
        # get current time
        t = isiPracMathClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=isiPracMathClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    TFClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        # get current time
        t = TFClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=TFClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
