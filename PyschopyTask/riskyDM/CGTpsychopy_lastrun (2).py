...
expName = 'CAPpsychopy'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/shlab/Desktop/CAPpsychopy_lastrun.py',
...
# Initialize components for Routine "lossInstructions"
lossInstructionsClock = core.Clock()
lossInst = visual.TextStim(win=win, name='lossInst',
    text='The next set of 20 trials will be identical to the previous trials, except:\n\n1) On each trial you will decide between a risky option with win\n and loss possible outcomes, and a guaranteed alternative of $0.\n\n2) These will be hypothetical trials, meaning that you\n will not recieve the outcome from any of these trials.\n\nThat said, we ask that you please make your\n choices as if the monetary amounts were real.\n\nWhen you are done, you will be redirected\n to the next task in this study.\n\nWhen you are ready to start, press "V" or "N".',
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
startLossResp = keyboard.Keyboard()

# Initialize components for Routine "lossTask"
lossTaskClock = core.Clock()
circleLeftReal_2 = visual.Rect(
    win=win, name='circleLeftReal_2',
    width=(.5, .5)[0], height=(.5, .5)[1],
    ori=0, pos=(-.4,0), anchor='center',
    lineWidth=1,     colorSpace='rgb',  lineColor=[1,1,1], fillColor=[1,1,1],
    opacity=1, depth=-1.0, interpolate=True)
circleRightReal_2 = visual.Rect(
    win=win, name='circleRightReal_2',
    width=(0.5, 0.5)[0], height=(0.5, 0.5)[1],
    ori=0, pos=(.4,0), anchor='center',
    lineWidth=1,     colorSpace='rgb',  lineColor='white', fillColor='white',
    opacity=1, depth=-2.0, interpolate=True)
lineLeftReal_2 = visual.Rect(
    win=win, name='lineLeftReal_2',
    width=(0.5, 0.01)[0], height=(0.5, 0.01)[1],
    ori=0, pos=[0,0], anchor='center',
    lineWidth=3,     colorSpace='rgb',  lineColor=[-1,-1,-1], fillColor=[-1,-1,-1],
    opacity=1, depth=-3.0, interpolate=True)
orTextReal_2 = visual.TextStim(win=win, name='orTextReal_2',
    text='OR',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-4.0);
lossTxtReal_2 = visual.TextStim(win=win, name='lossTxtReal_2',
    text='',
    font='Arial',
    pos=[0,0], height=0.1, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-5.0);
gainTxtReal_2 = visual.TextStim(win=win, name='gainTxtReal_2',
    text='',
    font='Arial',
    pos=[0,0], height=0.1, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-6.0);
safeTxtReal_2 = visual.TextStim(win=win, name='safeTxtReal_2',
    text='',
    font='Arial',
    pos=[0,0], height=0.1, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-7.0);
vLeftReal_2 = visual.TextStim(win=win, name='vLeftReal_2',
    text='V-Left',
    font='Arial',
    pos=(-.4, -.35), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-8.0);
nRightReal_2 = visual.TextStim(win=win, name='nRightReal_2',
    text='N-Right',
    font='Arial',
    pos=(.4, -.35), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-9.0);
realChoice_2 = keyboard.Keyboard()

# Initialize components for Routine "isiLoss"
isiLossClock = core.Clock()
isiLossText = visual.TextStim(win=win, name='isiLossText',
    text='+',
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
...
# Initialize components for Routine "feedbackLoss"
feedbackLossClock = core.Clock()
noRespTxtReal_2 = visual.TextStim(win=win, name='noRespTxtReal_2',
    text='You did not respond in time\n',
    font='Arial',
    pos=[0,0], height=0.08, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-1.0);
ocGambleReal_2 = visual.Rect(
    win=win, name='ocGambleReal_2',
    width=(0.5, 0.5)[0], height=(0.5, 0.5)[1],
    ori=0, pos=[0,0], anchor='center',
    lineWidth=1,     colorSpace='rgb',  lineColor=[1,1,1], fillColor=[1,1,1],
    opacity=1, depth=-2.0, interpolate=True)
ocSafeReal_2 = visual.Rect(
    win=win, name='ocSafeReal_2',
    width=(0.5, 0.5)[0], height=(0.5, 0.5)[1],
    ori=0, pos=[0,0], anchor='center',
    lineWidth=1,     colorSpace='rgb',  lineColor=[1,1,1], fillColor=[1,1,1],
    opacity=1, depth=-3.0, interpolate=True)
outcomeTextReal_2 = visual.TextStim(win=win, name='outcomeTextReal_2',
    text='',
    font='Arial',
    pos=[0,0], height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-4.0);
hideGambleReal_2 = visual.Rect(
    win=win, name='hideGambleReal_2',
    width=(0.6, 0.3)[0], height=(0.6, 0.3)[1],
    ori=0, pos=[0,0], anchor='center',
    lineWidth=1,     colorSpace='rgb',  lineColor=[-1,-1,-1], fillColor=[-1,-1,-1],
    opacity=1, depth=-5.0, interpolate=True)

# Initialize components for Routine "itiLoss"
itiLossClock = core.Clock()
itiTextReal_2 = visual.TextStim(win=win, name='itiTextReal_2',
    text='+',
    font='Arial',
    pos=(0, 0), height=0.03, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('capPractice.xlsx'),
...
# ------Prepare to start Routine "lossInstructions"-------
continueRoutine = True
# update component parameters for each repeat
startLossResp.keys = []
startLossResp.rt = []
_startLossResp_allKeys = []
# keep track of which components have finished
lossInstructionsComponents = [lossInst, startLossResp]
for thisComponent in lossInstructionsComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
lossInstructionsClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "lossInstructions"-------
while continueRoutine:
    # get current time
    t = lossInstructionsClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=lossInstructionsClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *lossInst* updates
    if lossInst.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        lossInst.frameNStart = frameN  # exact frame index
        lossInst.tStart = t  # local t and not account for scr refresh
        lossInst.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(lossInst, 'tStartRefresh')  # time at next scr refresh
        lossInst.setAutoDraw(True)
    
    # *startLossResp* updates
    waitOnFlip = False
    if startLossResp.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
        # keep track of start time/frame for later
        startLossResp.frameNStart = frameN  # exact frame index
        startLossResp.tStart = t  # local t and not account for scr refresh
        startLossResp.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(startLossResp, 'tStartRefresh')  # time at next scr refresh
        startLossResp.status = STARTED
        # keyboard checking is just starting
        waitOnFlip = True
        win.callOnFlip(startLossResp.clock.reset)  # t=0 on next screen flip
        win.callOnFlip(startLossResp.clearEvents, eventType='keyboard')  # clear events on next screen flip
    if startLossResp.status == STARTED and not waitOnFlip:
        theseKeys = startLossResp.getKeys(keyList=['v','n'], waitRelease=False)
        _startLossResp_allKeys.extend(theseKeys)
        if len(_startLossResp_allKeys):
            startLossResp.keys = _startLossResp_allKeys[-1].name  # just the last key pressed
            startLossResp.rt = _startLossResp_allKeys[-1].rt
            # a response ends the routine
            continueRoutine = False
...
# -------Ending Routine "lossInstructions"-------
for thisComponent in lossInstructionsComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('lossInst.started', lossInst.tStartRefresh)
thisExp.addData('lossInst.stopped', lossInst.tStopRefresh)
# check responses
if startLossResp.keys in ['', [], None]:  # No response was made
    startLossResp.keys = None
thisExp.addData('startLossResp.keys',startLossResp.keys)
if startLossResp.keys != None:  # we had a response
    thisExp.addData('startLossResp.rt', startLossResp.rt)
thisExp.addData('startLossResp.started', startLossResp.tStartRefresh)
thisExp.addData('startLossResp.stopped', startLossResp.tStopRefresh)
thisExp.nextEntry()
# the Routine "lossInstructions" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# set up handler to look after randomisation of conditions etc
lossTrials = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('capLossAversion/loss1.csv', selection='0:3'),
    seed=None, name='lossTrials')
thisExp.addLoop(lossTrials)  # add the loop to the experiment
thisLossTrial = lossTrials.trialList[0]  # so we can initialise stimuli with some values
# abbreviate parameter names if possible (e.g. rgb = thisLossTrial.rgb)
if thisLossTrial != None:
    for paramName in thisLossTrial:
        exec('{} = thisLossTrial[paramName]'.format(paramName))

for thisLossTrial in lossTrials:
    currentLoop = lossTrials
    # abbreviate parameter names if possible (e.g. rgb = thisLossTrial.rgb)
    if thisLossTrial != None:
        for paramName in thisLossTrial:
            exec('{} = thisLossTrial[paramName]'.format(paramName))
    
    # ------Prepare to start Routine "lossTask"-------
    continueRoutine = True
    routineTimer.add(4.000000)
    # update component parameters for each repeat
    if loc==1:
    ...
    if loc==1:
        ...
        gainLoc=[.4,.1]
        safeLoc=[-.4,0]
    circleRightReal_2.setFillColor([1,1,1])
    circleRightReal_2.setLineColor([1,1,1])
    lineLeftReal_2.setPos(targetPos)
    lossTxtReal_2.setPos(lossLoc)
    lossTxtReal_2.setText(riskyLoss)
    gainTxtReal_2.setPos(gainLoc)
    gainTxtReal_2.setText(riskyGain)
    safeTxtReal_2.setPos(safeLoc)
    safeTxtReal_2.setText(alternative)
    realChoice_2.keys = []
    realChoice_2.rt = []
    _realChoice_2_allKeys = []
    # keep track of which components have finished
    lossTaskComponents = [circleLeftReal_2, circleRightReal_2, lineLeftReal_2, orTextReal_2, lossTxtReal_2, gainTxtReal_2, safeTxtReal_2, vLeftReal_2, nRightReal_2, realChoice_2]
    for thisComponent in lossTaskComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    lossTaskClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "lossTask"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = lossTaskClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=lossTaskClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *circleLeftReal_2* updates
        if circleLeftReal_2.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            circleLeftReal_2.frameNStart = frameN  # exact frame index
            circleLeftReal_2.tStart = t  # local t and not account for scr refresh
            circleLeftReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(circleLeftReal_2, 'tStartRefresh')  # time at next scr refresh
            circleLeftReal_2.setAutoDraw(True)
        if circleLeftReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > circleLeftReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                circleLeftReal_2.tStop = t  # not accounting for scr refresh
                circleLeftReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(circleLeftReal_2, 'tStopRefresh')  # time at next scr refresh
                circleLeftReal_2.setAutoDraw(False)
        
        # *circleRightReal_2* updates
        if circleRightReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            circleRightReal_2.frameNStart = frameN  # exact frame index
            circleRightReal_2.tStart = t  # local t and not account for scr refresh
            circleRightReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(circleRightReal_2, 'tStartRefresh')  # time at next scr refresh
            circleRightReal_2.setAutoDraw(True)
        if circleRightReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > circleRightReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                circleRightReal_2.tStop = t  # not accounting for scr refresh
                circleRightReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(circleRightReal_2, 'tStopRefresh')  # time at next scr refresh
                circleRightReal_2.setAutoDraw(False)
        
        # *lineLeftReal_2* updates
        if lineLeftReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            lineLeftReal_2.frameNStart = frameN  # exact frame index
            lineLeftReal_2.tStart = t  # local t and not account for scr refresh
            lineLeftReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(lineLeftReal_2, 'tStartRefresh')  # time at next scr refresh
            lineLeftReal_2.setAutoDraw(True)
        if lineLeftReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > lineLeftReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                lineLeftReal_2.tStop = t  # not accounting for scr refresh
                lineLeftReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(lineLeftReal_2, 'tStopRefresh')  # time at next scr refresh
                lineLeftReal_2.setAutoDraw(False)
        
        # *orTextReal_2* updates
        if orTextReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            orTextReal_2.frameNStart = frameN  # exact frame index
            orTextReal_2.tStart = t  # local t and not account for scr refresh
            orTextReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(orTextReal_2, 'tStartRefresh')  # time at next scr refresh
            orTextReal_2.setAutoDraw(True)
        if orTextReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > orTextReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                orTextReal_2.tStop = t  # not accounting for scr refresh
                orTextReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(orTextReal_2, 'tStopRefresh')  # time at next scr refresh
                orTextReal_2.setAutoDraw(False)
        
        # *lossTxtReal_2* updates
        if lossTxtReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            lossTxtReal_2.frameNStart = frameN  # exact frame index
            lossTxtReal_2.tStart = t  # local t and not account for scr refresh
            lossTxtReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(lossTxtReal_2, 'tStartRefresh')  # time at next scr refresh
            lossTxtReal_2.setAutoDraw(True)
        if lossTxtReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > lossTxtReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                lossTxtReal_2.tStop = t  # not accounting for scr refresh
                lossTxtReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(lossTxtReal_2, 'tStopRefresh')  # time at next scr refresh
                lossTxtReal_2.setAutoDraw(False)
        
        # *gainTxtReal_2* updates
        if gainTxtReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            gainTxtReal_2.frameNStart = frameN  # exact frame index
            gainTxtReal_2.tStart = t  # local t and not account for scr refresh
            gainTxtReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(gainTxtReal_2, 'tStartRefresh')  # time at next scr refresh
            gainTxtReal_2.setAutoDraw(True)
        if gainTxtReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > gainTxtReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                gainTxtReal_2.tStop = t  # not accounting for scr refresh
                gainTxtReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(gainTxtReal_2, 'tStopRefresh')  # time at next scr refresh
                gainTxtReal_2.setAutoDraw(False)
        
        # *safeTxtReal_2* updates
        if safeTxtReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            safeTxtReal_2.frameNStart = frameN  # exact frame index
            safeTxtReal_2.tStart = t  # local t and not account for scr refresh
            safeTxtReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(safeTxtReal_2, 'tStartRefresh')  # time at next scr refresh
            safeTxtReal_2.setAutoDraw(True)
        if safeTxtReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > safeTxtReal_2.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
                safeTxtReal_2.tStop = t  # not accounting for scr refresh
                safeTxtReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(safeTxtReal_2, 'tStopRefresh')  # time at next scr refresh
                safeTxtReal_2.setAutoDraw(False)
        
        # *vLeftReal_2* updates
        if vLeftReal_2.status == NOT_STARTED and tThisFlip >= 2-frameTolerance:
            # keep track of start time/frame for later
            vLeftReal_2.frameNStart = frameN  # exact frame index
            vLeftReal_2.tStart = t  # local t and not account for scr refresh
            vLeftReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(vLeftReal_2, 'tStartRefresh')  # time at next scr refresh
            vLeftReal_2.setAutoDraw(True)
        if vLeftReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > vLeftReal_2.tStartRefresh + 2-frameTolerance:
                # keep track of stop time/frame for later
                vLeftReal_2.tStop = t  # not accounting for scr refresh
                vLeftReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(vLeftReal_2, 'tStopRefresh')  # time at next scr refresh
                vLeftReal_2.setAutoDraw(False)
        
        # *nRightReal_2* updates
        if nRightReal_2.status == NOT_STARTED and tThisFlip >= 2-frameTolerance:
            # keep track of start time/frame for later
            nRightReal_2.frameNStart = frameN  # exact frame index
            nRightReal_2.tStart = t  # local t and not account for scr refresh
            nRightReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(nRightReal_2, 'tStartRefresh')  # time at next scr refresh
            nRightReal_2.setAutoDraw(True)
        if nRightReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > nRightReal_2.tStartRefresh + 2-frameTolerance:
                # keep track of stop time/frame for later
                nRightReal_2.tStop = t  # not accounting for scr refresh
                nRightReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(nRightReal_2, 'tStopRefresh')  # time at next scr refresh
                nRightReal_2.setAutoDraw(False)
        
        # *realChoice_2* updates
        waitOnFlip = False
        if realChoice_2.status == NOT_STARTED and tThisFlip >= 2-frameTolerance:
            # keep track of start time/frame for later
            realChoice_2.frameNStart = frameN  # exact frame index
            realChoice_2.tStart = t  # local t and not account for scr refresh
            realChoice_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(realChoice_2, 'tStartRefresh')  # time at next scr refresh
            realChoice_2.status = STARTED
            # keyboard checking is just starting
            waitOnFlip = True
            win.callOnFlip(realChoice_2.clock.reset)  # t=0 on next screen flip
            win.callOnFlip(realChoice_2.clearEvents, eventType='keyboard')  # clear events on next screen flip
        if realChoice_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > realChoice_2.tStartRefresh + 2-frameTolerance:
                # keep track of stop time/frame for later
                realChoice_2.tStop = t  # not accounting for scr refresh
                realChoice_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(realChoice_2, 'tStopRefresh')  # time at next scr refresh
                realChoice_2.status = FINISHED
        if realChoice_2.status == STARTED and not waitOnFlip:
            theseKeys = realChoice_2.getKeys(keyList=['v','n'], waitRelease=False)
            _realChoice_2_allKeys.extend(theseKeys)
            if len(_realChoice_2_allKeys):
                realChoice_2.keys = _realChoice_2_allKeys[-1].name  # just the last key pressed
                realChoice_2.rt = _realChoice_2_allKeys[-1].rt
                # a response ends the routine
                continueRoutine = False
    ...
    # -------Ending Routine "lossTask"-------
    for thisComponent in lossTaskComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    lossTrials.addData('circleLeftReal_2.started', circleLeftReal_2.tStartRefresh)
    lossTrials.addData('circleLeftReal_2.stopped', circleLeftReal_2.tStopRefresh)
    lossTrials.addData('circleRightReal_2.started', circleRightReal_2.tStartRefresh)
    lossTrials.addData('circleRightReal_2.stopped', circleRightReal_2.tStopRefresh)
    lossTrials.addData('lineLeftReal_2.started', lineLeftReal_2.tStartRefresh)
    lossTrials.addData('lineLeftReal_2.stopped', lineLeftReal_2.tStopRefresh)
    lossTrials.addData('orTextReal_2.started', orTextReal_2.tStartRefresh)
    lossTrials.addData('orTextReal_2.stopped', orTextReal_2.tStopRefresh)
    lossTrials.addData('lossTxtReal_2.started', lossTxtReal_2.tStartRefresh)
    lossTrials.addData('lossTxtReal_2.stopped', lossTxtReal_2.tStopRefresh)
    lossTrials.addData('gainTxtReal_2.started', gainTxtReal_2.tStartRefresh)
    lossTrials.addData('gainTxtReal_2.stopped', gainTxtReal_2.tStopRefresh)
    lossTrials.addData('safeTxtReal_2.started', safeTxtReal_2.tStartRefresh)
    lossTrials.addData('safeTxtReal_2.stopped', safeTxtReal_2.tStopRefresh)
    lossTrials.addData('vLeftReal_2.started', vLeftReal_2.tStartRefresh)
    lossTrials.addData('vLeftReal_2.stopped', vLeftReal_2.tStopRefresh)
    lossTrials.addData('nRightReal_2.started', nRightReal_2.tStartRefresh)
    lossTrials.addData('nRightReal_2.stopped', nRightReal_2.tStopRefresh)
    # check responses
    if realChoice_2.keys in ['', [], None]:  # No response was made
        realChoice_2.keys = None
    lossTrials.addData('realChoice_2.keys',realChoice_2.keys)
    if realChoice_2.keys != None:  # we had a response
        lossTrials.addData('realChoice_2.rt', realChoice_2.rt)
    lossTrials.addData('realChoice_2.started', realChoice_2.tStartRefresh)
    lossTrials.addData('realChoice_2.stopped', realChoice_2.tStopRefresh)
    
    # ------Prepare to start Routine "isiLoss"-------
    continueRoutine = True
    # update component parameters for each repeat
    # keep track of which components have finished
    isiLossComponents = [isiLossText]
    for thisComponent in isiLossComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    isiLossClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "isiLoss"-------
    while continueRoutine:
        # get current time
        t = isiLossClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=isiLossClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *isiLossText* updates
        if isiLossText.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            isiLossText.frameNStart = frameN  # exact frame index
            isiLossText.tStart = t  # local t and not account for scr refresh
            isiLossText.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(isiLossText, 'tStartRefresh')  # time at next scr refresh
            isiLossText.setAutoDraw(True)
        if isiLossText.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > isiLossText.tStartRefresh + isi-frameTolerance:
                # keep track of stop time/frame for later
                isiLossText.tStop = t  # not accounting for scr refresh
                isiLossText.frameNStop = frameN  # exact frame index
                win.timeOnFlip(isiLossText, 'tStopRefresh')  # time at next scr refresh
                isiLossText.setAutoDraw(False)
    ...
    # -------Ending Routine "isiLoss"-------
    for thisComponent in isiLossComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    lossTrials.addData('isiLossText.started', isiLossText.tStartRefresh)
    lossTrials.addData('isiLossText.stopped', isiLossText.tStopRefresh)
    # the Routine "isiLoss" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # ------Prepare to start Routine "feedbackLoss"-------
    continueRoutine = True
    routineTimer.add(1.000000)
    # update component parameters for each repeat
    import random
    ...
    noRespTxtReal_2.setPos(noRespLoc)
    ocGambleReal_2.setPos(ocGambleLoc)
    ocSafeReal_2.setPos(ocSafeLoc)
    outcomeTextReal_2.setColor('black', colorSpace='rgb')
    outcomeTextReal_2.setPos(ocLoc)
    outcomeTextReal_2.setText(realOutcome)
    hideGambleReal_2.setPos(hideGamLoc)
    # keep track of which components have finished
    feedbackLossComponents = [noRespTxtReal_2, ocGambleReal_2, ocSafeReal_2, outcomeTextReal_2, hideGambleReal_2]
    for thisComponent in feedbackLossComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    feedbackLossClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "feedbackLoss"-------
    while continueRoutine and routineTimer.getTime() > 0:
        # get current time
        t = feedbackLossClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=feedbackLossClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *noRespTxtReal_2* updates
        if noRespTxtReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            noRespTxtReal_2.frameNStart = frameN  # exact frame index
            noRespTxtReal_2.tStart = t  # local t and not account for scr refresh
            noRespTxtReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(noRespTxtReal_2, 'tStartRefresh')  # time at next scr refresh
            noRespTxtReal_2.setAutoDraw(True)
        if noRespTxtReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > noRespTxtReal_2.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
                noRespTxtReal_2.tStop = t  # not accounting for scr refresh
                noRespTxtReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(noRespTxtReal_2, 'tStopRefresh')  # time at next scr refresh
                noRespTxtReal_2.setAutoDraw(False)
        
        # *ocGambleReal_2* updates
        if ocGambleReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ocGambleReal_2.frameNStart = frameN  # exact frame index
            ocGambleReal_2.tStart = t  # local t and not account for scr refresh
            ocGambleReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(ocGambleReal_2, 'tStartRefresh')  # time at next scr refresh
            ocGambleReal_2.setAutoDraw(True)
        if ocGambleReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > ocGambleReal_2.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
                ocGambleReal_2.tStop = t  # not accounting for scr refresh
                ocGambleReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(ocGambleReal_2, 'tStopRefresh')  # time at next scr refresh
                ocGambleReal_2.setAutoDraw(False)
        
        # *ocSafeReal_2* updates
        if ocSafeReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ocSafeReal_2.frameNStart = frameN  # exact frame index
            ocSafeReal_2.tStart = t  # local t and not account for scr refresh
            ocSafeReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(ocSafeReal_2, 'tStartRefresh')  # time at next scr refresh
            ocSafeReal_2.setAutoDraw(True)
        if ocSafeReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > ocSafeReal_2.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
                ocSafeReal_2.tStop = t  # not accounting for scr refresh
                ocSafeReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(ocSafeReal_2, 'tStopRefresh')  # time at next scr refresh
                ocSafeReal_2.setAutoDraw(False)
        
        # *outcomeTextReal_2* updates
        if outcomeTextReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            outcomeTextReal_2.frameNStart = frameN  # exact frame index
            outcomeTextReal_2.tStart = t  # local t and not account for scr refresh
            outcomeTextReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(outcomeTextReal_2, 'tStartRefresh')  # time at next scr refresh
            outcomeTextReal_2.setAutoDraw(True)
        if outcomeTextReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > outcomeTextReal_2.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
                outcomeTextReal_2.tStop = t  # not accounting for scr refresh
                outcomeTextReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(outcomeTextReal_2, 'tStopRefresh')  # time at next scr refresh
                outcomeTextReal_2.setAutoDraw(False)
        
        # *hideGambleReal_2* updates
        if hideGambleReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            hideGambleReal_2.frameNStart = frameN  # exact frame index
            hideGambleReal_2.tStart = t  # local t and not account for scr refresh
            hideGambleReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(hideGambleReal_2, 'tStartRefresh')  # time at next scr refresh
            hideGambleReal_2.setAutoDraw(True)
        if hideGambleReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > hideGambleReal_2.tStartRefresh + 1.0-frameTolerance:
                # keep track of stop time/frame for later
                hideGambleReal_2.tStop = t  # not accounting for scr refresh
                hideGambleReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(hideGambleReal_2, 'tStopRefresh')  # time at next scr refresh
                hideGambleReal_2.setAutoDraw(False)
    ...
    # -------Ending Routine "feedbackLoss"-------
    for thisComponent in feedbackLossComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('realOutcome', realOutcome)
    lossTrials.addData('noRespTxtReal_2.started', noRespTxtReal_2.tStartRefresh)
    lossTrials.addData('noRespTxtReal_2.stopped', noRespTxtReal_2.tStopRefresh)
    lossTrials.addData('ocGambleReal_2.started', ocGambleReal_2.tStartRefresh)
    lossTrials.addData('ocGambleReal_2.stopped', ocGambleReal_2.tStopRefresh)
    lossTrials.addData('ocSafeReal_2.started', ocSafeReal_2.tStartRefresh)
    lossTrials.addData('ocSafeReal_2.stopped', ocSafeReal_2.tStopRefresh)
    lossTrials.addData('outcomeTextReal_2.started', outcomeTextReal_2.tStartRefresh)
    lossTrials.addData('outcomeTextReal_2.stopped', outcomeTextReal_2.tStopRefresh)
    lossTrials.addData('hideGambleReal_2.started', hideGambleReal_2.tStartRefresh)
    lossTrials.addData('hideGambleReal_2.stopped', hideGambleReal_2.tStopRefresh)
    
    # ------Prepare to start Routine "itiLoss"-------
    continueRoutine = True
    # update component parameters for each repeat
    # keep track of which components have finished
    itiLossComponents = [itiTextReal_2]
    for thisComponent in itiLossComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    itiLossClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "itiLoss"-------
    while continueRoutine:
        # get current time
        t = itiLossClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=itiLossClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *itiTextReal_2* updates
        if itiTextReal_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            itiTextReal_2.frameNStart = frameN  # exact frame index
            itiTextReal_2.tStart = t  # local t and not account for scr refresh
            itiTextReal_2.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(itiTextReal_2, 'tStartRefresh')  # time at next scr refresh
            itiTextReal_2.setAutoDraw(True)
        if itiTextReal_2.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > itiTextReal_2.tStartRefresh + iti-frameTolerance:
                # keep track of stop time/frame for later
                itiTextReal_2.tStop = t  # not accounting for scr refresh
                itiTextReal_2.frameNStop = frameN  # exact frame index
                win.timeOnFlip(itiTextReal_2, 'tStopRefresh')  # time at next scr refresh
                itiTextReal_2.setAutoDraw(False)
    ...
    # -------Ending Routine "itiLoss"-------
    for thisComponent in itiLossComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    lossTrials.addData('itiTextReal_2.started', itiTextReal_2.tStartRefresh)
    lossTrials.addData('itiTextReal_2.stopped', itiTextReal_2.tStopRefresh)
    # the Routine "itiLoss" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
    
# completed 1 repeats of 'lossTrials'
